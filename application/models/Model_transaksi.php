...
class Model_transaksi extends CI_Model {
    ...
    function get_sign($id){
        $data = $this->db->query("select user_toko.nama from transaksi, user_toko where transaksi.id_user_toko = user_toko.id AND transaksi.kd_transaksi = $id")->row();
        return $data;
    }
