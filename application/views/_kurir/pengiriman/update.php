        ...
        <div class="col-md-12">
          <div class="card">
            <div class="card-header">
              <h5 class="card-title">Edit Data Pengiriman</h5>
            </div>
            <div class="card-body">
                ...
                <div class="row">
                  ...
                  <div class="col-md-12">
                    <div class="form-group">
                      ...
                      <select data-opt="<?= $data->kd_transaksi;?>"class="form-control" name="kd_transaksi" id="kd_transaksi">
                  ...
                  <div class="col-md-12">
                    <div class="form-group">
                      ...
                      <input value="<?= $data->status_pengiriman;?>" name="status_pengiriman" id="status_pengiriman" type="number" class="form-control" placeholder="status_pengiriman">
                    </div>
                  </div>
