        ...
        <div class="col-md-12">
          <div class="card">
            ...
            <div class="card-body">
              ...
              <form method="post" action="<?= base_url().'transaksi/do_update/'.$data->kd_transaksi; ?>"  enctype="multipart/form-data">
                <div class="row">
                    ...
                    <div class="form-group">
                      ...
                      <div class="input-group">
                        <div class="custom-file">
                          <input type="file" class="custom-file-input" id="bukti_pembayaran" value="<?= $data->bukti_pembayaran;?>" name="bukti_pembayaran">
